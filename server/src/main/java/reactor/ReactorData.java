...
public class ReactorData<T> {
    ...
    private final ServerProtocolFactory<String> _protocolMaker;
	...
	public ReactorData(ExecutorService _executor, Selector _selector, ServerProtocolFactory<String> protocol, TokenizerFactory<T> tokenizer) {
	...
	public ServerProtocolFactory<String> getProtocolMaker() {
